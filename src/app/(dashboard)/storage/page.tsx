          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[#2e2e2e]">
                ...
                <th className="text-left px-4 py-3 text-xs font-medium text-[#666] uppercase tracking-wide hidden lg:table-cell">
                  Uploaded
                </th>
            ...
            <tbody className="divide-y divide-[#2e2e2e]">
              {loading ? (
                <tr>
                  <td colSpan={5} className="px-4 py-8 text-center text-[#666] text-sm">
                    Loading files...
                  </td>
                </tr>
              ) : files.length === 0 ? (
                  ...
                  <tr key={file.id} className="hover:bg-[#222] transition-colors group">
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2.5">
                        ...
                        <span className="text-sm text-[#ededed] truncate max-w-[200px]">
                          {file.filename}
                        </span>
                      </div>
                    </td>
